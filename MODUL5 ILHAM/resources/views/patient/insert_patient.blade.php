    ...
    <div class="form">
        <form action="{{route('patient.store')}}" method="post" autocomplete="off">
          ...
          <div class="form-group my-2">
            ...
            <input name="vaccine_id" id="vaccine_id"  class="form-control" type="text" readonly value="{{$vaccine->id}}">
          </div>
        ...
        <div class="form-group my-2">
          ...
          <div class="form-group my-2">
              <div class="custom-file">
                  ...
                  <input type="file" id="image_ktp" class="form-control" name="image_ktp">
                </div>
            </div>
