        ...
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item">
                <a class="nav-link {{ ($title =="Vaccine") ? 'active' : '' }}" href="{{route('vaccine.home-view')}}">Vaccine</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ ($title =="Patient") ? 'active' : '' }}" href="{{route('patient.home-view')}}">Patient</a>
              </li>
            </ul>
          </div>
        </div>
